...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/601eb40d9563bc0015145a1c
...
To start editing your site, you can use the Sanity interface at https://harry-test-eb40d.sanity.studio/.
...
Generated at `2021-02-06T15:24:40.716Z` by Stackbit version `0.3.47`.